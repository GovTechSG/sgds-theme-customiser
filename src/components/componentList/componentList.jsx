	...
	return (
		<div className="p-6 bg-light">
				...
				<div>
					...
					<div className="mb-2">
						<Button
							style={{ backgroundColor: props.themePrimaryColor, border: "1px solid" + props.themePrimaryColor }}
							className="me-2"
						>
							Primary
						</Button>
						<Button
							style={{ backgroundColor: props.themeSecondaryColor, border: "1px solid" + props.themeSecondaryColor }}
							className="me-2"
						>
							Secondary
						</Button>
						<Button
							style={{ backgroundColor: props.infoColor, border: "1px solid" + props.infoColor }}
							className="me-2"
						>
							Info
						</Button>
						<Button
							style={{ backgroundColor: props.successColor, border: "1px solid" + props.successColor }}
							className="me-2"
						>
							Success
						</Button>
						<Button
							style={{ backgroundColor: props.dangerColor, border: "1px solid" + props.dangerColor }}
							className="me-2"
						>
							Danger
						</Button>
						<Button
							style={{ backgroundColor: props.warningColor, color: "black", border: "1px solid" + props.warningColor }}
							className="me-2"
						>
							Warning
						</Button>
					...
					<div className="row">
						...
						<div className="col">
							...
							<p>
								...
								<a href="" style={{ color: props.infoColor }}>Cum sociis natoque penatibus</a> et magnis dis
						...
						<div className="col">
							...
							<p style={{ color: props.themePrimaryColor }}>
								Nullam quis risus eget urna mollis ornare vel eu leo.
							</p>
							<p style={{ color: props.themeSecondaryColor }}>
								Nullam quis risus eget urna mollis ornare vel eu leo.
							</p>
							<p style={{ color: props.successColor }}>
								Nullam quis risus eget urna mollis ornare vel eu leo.
							</p>
							<p style={{ color: props.infoColor }}>
								Nullam quis risus eget urna mollis ornare vel eu leo.
							</p>
							<p style={{ color: props.warningColor }}>
								Nullam quis risus eget urna mollis ornare vel eu leo.
							</p>
							<p style={{ color: props.dangerColor }}>
								Nullam quis risus eget urna mollis ornare vel eu leo.
							</p>
				...
				<div>
					...
					<table className="table bg-white">
						...
						<tbody>
							...
							<tr
								style={{
									backgroundColor: props.themePrimaryColor
								}}
							...
							<tr
								style={{
									backgroundColor: props.themeSecondaryColor
								}}
								className="text-white"
							>
								<td>Data 2A</td>
							...
							<tr
								style={{
									backgroundColor: props.dangerColor
								}}
								className="text-white"
							>
								<td>Data 3A</td>
				...
				<div>
					...
					<div className="row">
						...
						<div className="col col-md-4">
							<Card style={{ backgroundColor: props.themePrimaryColor, color: "white" }}>
								<Card.Header>
									Lorem Ipsum
								</Card.Header>
								<Card.Body>
